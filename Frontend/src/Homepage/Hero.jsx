              ...
              <section className="py-6 px-4">
                <div className="max-w-3xl">
                  ...
                  <p className="text-base text-white font-semibold mt-2">
                    Post jobs, review applications, and connect with top
            ...
            {user?.role == "user" && (
              ...
              >
                <input
                  ...
                  className="h-12 sm:h-16 w-full sm:w-72 rounded-t-lg sm:rounded-l-lg sm:rounded-t-none bg-darkGray text-black pl-4 border-b-2 sm:border-r-2 border-solid outline-none text-lg sm:text-[20px]"
                  name="keyword"
                  ref={keyword}
                />
                <input
